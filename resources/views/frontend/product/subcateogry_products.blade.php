...
@section('title')
SubCategory Products - {{ $subcategory->subcategory_name_en }}
@endsection
          ...
          <div class="row align-items-center">
             <div class="col-md-7">
                <div class="header-content">
                   <h1>
                       @if(session()->get('language') == 'arabic') تصنيف فرعي @else SubCategory @endif 
                    </h1>
                   <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                         <li class="breadcrumb-item"><a href="{{ url('/') }}">@if(session()->get('language') == 'arabic') مسكن @else Home @endif</a></li>
                         <li class="breadcrumb-item active" aria-current="page">@if(session()->get('language') == 'arabic') تصنيف فرعي @else SubCategory @endif </li>
                      </ol>
                   </nav>
                </div>
             </div>
