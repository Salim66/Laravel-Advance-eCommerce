...
<div class="col-md-2"><br>
    ...
    <ul class="list-group list-group-flush">
        ...
        <a href="{{ route('return.order.list') }}" class="btn btn-primary btn-sm btn-block mb-1">Return Orders</a>
        <a href="{{ route('cancel.order') }}" class="btn btn-primary btn-sm btn-block mb-1">Cancel Orders</a>
