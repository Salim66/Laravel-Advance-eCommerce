...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: #085CA4; font-size: 26px;"><strong>Elegant Furnitur QR</strong></h2>
        </td>
        @php
        ...
        <td align="right">
            <pre class="font" >
               Elegant Furnitur QR Head Office
               Email: {{ $contact->email_address }} <br>
               Mob: {{ $contact->cell_number }} <br>
               {{ $contact->address }} <br>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
    <tr>
        ...
        <td>
          <p class="font">
            <h3><span style="color: #085CA4;">Invoice:</span> #{{ $order->invoice_no}}</h3>
...
<h3>Products</h3>
  <table width="100%">
    <thead style="background-color: #085CA4; color:#FFFFFF;">
      <tr class="font">
        <th>Image</th>
        <th>Product Name</th>
        <th>Size</th>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: #085CA4;">Subtotal:</span>${{ $order->amount }}</h2>
            <h2><span style="color: #085CA4;">Total:</span> ${{ $order->amount }}</h2>
