...
$(".quick-add-to-cart-trigger").on("click",function(e){e.preventDefault();$(".quick-add-to-cart-wrapper").addClass("active");})
$(".quick-view-trigger").on("click",function(e){e.preventDefault();$(".quick-view-wrapper").addClass("active");})
$(".quick-add-to-cart-close").on("click",function(){$(".quick-add-to-cart-wrapper").removeClass("active");})
...
var $grid=$(".product-tab-gallery").isotope({itemSelector:'.element-item',layoutMode:'fitRows',});$(".product-selection-tab").on('click','li',function(){var filterValue=$(this).attr('data-filter');$grid.isotope({filter:filterValue});});$(".product-selection-tab li").on('click',function(){$(this).addClass("active").siblings().removeClass("active")});$(".recent-product-item").slice(0,4).show();$(".product-all-item").slice(0,12).show();$(".load-more-btn").on("click",function(e){e.preventDefault();$(this).parent(".load-more").siblings(".recent-arrival-gallery").find(".recent-product-item:hidden").slice(0,4).slideDown();$(this).parent(".load-more").siblings(".product-all-gallery").find(".product-all-item:hidden").slice(0,4).slideDown();})
